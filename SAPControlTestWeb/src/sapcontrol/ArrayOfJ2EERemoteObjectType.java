...
public class ArrayOfJ2EERemoteObjectType {

    @XmlElement(nillable = true)
    protected List<J2EERemoteObjectType> item;
     ...
     * {@link J2EERemoteObjectType }
     * 
     * 
     */
    public List<J2EERemoteObjectType> getItem() {
        if (item == null) {
            item = new ArrayList<J2EERemoteObjectType>();
        }
        return this.item;
    }
