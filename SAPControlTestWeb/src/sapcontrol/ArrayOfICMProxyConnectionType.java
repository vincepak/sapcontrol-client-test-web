...
public class ArrayOfICMProxyConnectionType {

    @XmlElement(nillable = true)
    protected List<ICMProxyConnectionType> item;
     ...
     * {@link ICMProxyConnectionType }
     * 
     * 
     */
    public List<ICMProxyConnectionType> getItem() {
        if (item == null) {
            item = new ArrayList<ICMProxyConnectionType>();
        }
        return this.item;
    }
