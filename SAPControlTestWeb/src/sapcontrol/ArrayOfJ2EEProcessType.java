...
public class ArrayOfJ2EEProcessType {

    @XmlElement(nillable = true)
    protected List<J2EEProcessType> item;
     ...
     * {@link J2EEProcessType }
     * 
     * 
     */
    public List<J2EEProcessType> getItem() {
        if (item == null) {
            item = new ArrayList<J2EEProcessType>();
        }
        return this.item;
    }
