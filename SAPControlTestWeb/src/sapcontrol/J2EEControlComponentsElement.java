...
@XmlRootElement(name = "J2EEControlComponents")
public class J2EEControlComponentsElement {
    ...
    @XmlElementRef(name = "componentType", type = JAXBElement.class)
    protected JAXBElement<String> componentType;
    @XmlElementRef(name = "componentNames", type = JAXBElement.class)
    protected JAXBElement<String> componentNames;
     ...
     *     
     */
    public JAXBElement<String> getComponentNames() {
     ...
     *     
     */
    public void setComponentNames(JAXBElement<String> value) {
