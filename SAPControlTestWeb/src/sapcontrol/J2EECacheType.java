...
/**
 * <p>Java class for J2EECache complex type.
 * 
...
@XmlType(name = "J2EECache", propOrder = {
    "cachename",
    "processname",
    "type",
    "size",
...
public class J2EECacheType {

    @XmlElementRef(name = "cachename", type = JAXBElement.class)
    protected JAXBElement<String> cachename;
     ...
     *     
     */
    public JAXBElement<String> getCachename() {
        return cachename;
    }
     ...
     *     
     */
    public void setCachename(JAXBElement<String> value) {
